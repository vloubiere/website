...
subtitle: '<br> A compelling work signed Flora Paldi, congrats! [Read the paper online {{< icon name="external-link-alt" pack="fas" >}}](https://www.nature.com/articles/s41588-025-02489-4) or [download it {{< icon name="file-pdf" pack="fas" >}}](https://vloubiere.github.io/website/publication/paldi-2026/paldi-2026.pdf). For a shorter digest, click [here {{< icon name="external-link-alt" pack="fas" >}}](https://communities.springernature.com/posts/how-do-cells-remember-their-past-an-unexpected-role-for-genome-folding?channel_id=behind-the-paper) or watch [our video {{< icon name="external-link-alt" pack="fas" >}}](https://www.youtube.com/watch?v=VtmWJDiSLho&t=5s)'
date: 2026-02-04
image:
  focal_point: 'top'
share: false  
